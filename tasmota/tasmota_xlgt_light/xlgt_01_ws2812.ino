...
#ifdef USE_DERG_RGB
#ifdef USE_NETWORK_LIGHT_SCHEMES
ColorScheme kSchemes[WS2812_SCHEMES -3] = {  // Skip clock scheme and DDP scheme and Dragon scheme
#else
ColorScheme kSchemes[WS2812_SCHEMES -2] = {  // Skip clock scheme and Dragon scheme
#endif
#else
#ifdef USE_NETWORK_LIGHT_SCHEMES
